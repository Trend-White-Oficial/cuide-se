                    ...
                    <form>
                        ...
                        <div className="form-group">
                            ...
                            <textarea
                                ...
                                onChange={(e) => setFormData({ ...formData, especialidades: e.target.value.split('\n') })}
                            />
                        </div>
                        <div className="form-group">
                            <label>Formação</label>
                            <textarea
                                value={formData.formacao.join('\n')}
                                onChange={(e) => setFormData({ ...formData, formacao: e.target.value.split('\n') })}
                            />
                        </div>
                        <div className="form-group">
                            ...
                            <textarea
                                ...
                                onChange={(e) => setFormData({ ...formData, certificacoes: e.target.value.split('\n') })}
                            />
                        </div>
                        <div className="form-group">
                            <label>Disponibilidade</label>
                            <textarea
                                value={formData.disponibilidade.join('\n')}
                                onChange={(e) => setFormData({ ...formData, disponibilidade: e.target.value.split('\n') })}
                            />
                        </div>
                        <div className="form-group">
            ...
            <section className="profile-section">
                ...
                <div className="professional-info">
                    ...
                    <div className="info-section">
                        <h3>Formação</h3>
                        <ul>
                            {profile.formacao?.map((formacao, index) => (
                    ...
                    <div className="info-section">
                        <h3>Certificações</h3>
                        <ul>
                            {profile.certificacoes?.map((certificacao, index) => (
                    ...
                    <div className="info-section">
                        ...
                        <ul>
                            {profile.disponibilidade?.map((horario, index) => (
